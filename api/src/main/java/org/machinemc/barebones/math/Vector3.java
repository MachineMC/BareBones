...
public record Vector3(double x, double y, double z) implements Cloneable {
    ...
    /**
     * Divide the components of the other vector by this one and returns a copy.
     *
     * @param other the 3D vector
     * @return copy
     */
    ...
    public Vector3 rotateAroundX(final double angle) {
        ...
        final double y = angleCos * y() - angleSin * z();
        final double z = angleSin * y() + angleCos * z();
    ...
    public Vector3 rotateAroundY(final double angle) {
        ...
        final double x = angleCos * x() + angleSin * z();
        final double z = -angleSin * x() + angleCos * z();
    ...
    public Vector3 rotateAroundZ(final double angle) {
        ...
        final double x = angleCos * x() - angleSin * y();
        final double y = angleSin * x() + angleCos * y();
