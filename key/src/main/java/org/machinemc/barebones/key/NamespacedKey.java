package org.machinemc.barebones.key;
...
public record NamespacedKey(String namespace, String key) implements Comparable<NamespacedKey> {
    ...
    private static final Comparator<? super NamespacedKey> COMPARATOR = Comparator
            .comparing(NamespacedKey::key)
    ...
    public String toString() {
        return namespace + DEFAULT_SEPARATOR + key;
    }
    ...
    static Optional<String[]> parseNamespacedKey(final String input) {
        ...
        final int separator = input.indexOf(DEFAULT_SEPARATOR);
