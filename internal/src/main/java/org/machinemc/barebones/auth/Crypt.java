...
public final class Crypt {
    ...
    /**
     * Creates encryption context for given secret key.
     *
     ...
     */
    public static EncryptionContext createEncryptionContext(final SecretKey key) throws InvalidKeyException {
        Preconditions.checkNotNull(key, "Secret key can not be null");
        return new EncryptionContext(getCipher(Cipher.ENCRYPT_MODE, key), getCipher(Cipher.DECRYPT_MODE, key));
    }
